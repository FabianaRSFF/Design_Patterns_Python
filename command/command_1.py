# Command ( padrão de projeto comportamental) tem intenção de 
# encapsular uma solicitação como objeto, dessa forma permitindo
# parametrizar clientes com diferentes solicitações, enfileirar 
# ou fazer registro (log) de solicitações e suportar solicitações 
