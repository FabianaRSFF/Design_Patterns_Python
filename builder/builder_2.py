#  É um padrão de criação que tem a intenção de separar a 
# contrução de um objeto complexo de sua representação, de modo que
...
if __name__=='__main__':
    ...
    user1 = user_director.with_age('Fabinada', 'Burra', 440)
    user2 = user_director.with_address('Fabinada', 'Burra', 'Av.Brasil')
    print(user1)
    print(user2)
